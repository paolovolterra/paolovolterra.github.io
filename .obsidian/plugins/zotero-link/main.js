        ...
        function(modules) {
          ...
          function(module3, exports2, __webpack_require__) {
            ...
            module3.exports = {
              ...
              renderString: function renderString2(src, ctx, cb) {
                if (!e) {
                  configure();
                }
...
// src/ZoteroLinkSettingTab.ts
var import_obsidian = require("obsidian");
var ZoteroLinkSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(this.containerEl).setName("Link title template").setDesc(description).addText((text) => text.setPlaceholder("default: {{ title }}").setValue(this.plugin.settings.linkTemplate).onChange((value) => __async(this, null, function* () {
    ...
    new import_obsidian.Setting(this.containerEl).setDesc(availableKeywords);
  }
};

// src/ZoteroLinkSettings.ts
...
function pluginApi(name) {
  if ("PluginApi" in window && name in window["PluginApi"]) {
    ...
    new import_obsidian2.Notice(`Plugin ${name} not found. Please install ${name} first.`);
  }
}

// src/ZoteroLink.ts
var import_nunjucks = __toESM(require_nunjucks());
var ZoteroLink = class extends import_obsidian3.Plugin {
  onload() {
    return __async(this, null, function* () {
      ...
      this.addCommand({
        ...
        editorCallback: (editor) => __async(this, null, function* () {
          pluginApi("ZoteroBridge").v1().search().then((item) => {
  ...
  getLinkTemplate(item) {
    return `[${(0, import_nunjucks.renderString)(this.settings.linkTemplate, item.getValues())}](zotero://select/library/items/${item.getKey()})`;
  }
};

// src/main.ts
var main_default = ZoteroLink;
